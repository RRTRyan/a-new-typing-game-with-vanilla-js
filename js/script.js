...
const startTest = (wordCount = 5) => {
    ...
    wordsToType.forEach((word, index) => {
        ...
        if (index === 0) span.style.color = "#4B2E2B"; // Highlight first word
...
const highlightNextWord = () => {
    ...
    if (currentWordIndex < wordElements.length) {
        if (currentWordIndex > 0) {
            wordElements[currentWordIndex -1 ].style.color = "#F4E3D7";
        }
        wordElements[currentWordIndex].style.color = "#4B2E2B";
    }
};
